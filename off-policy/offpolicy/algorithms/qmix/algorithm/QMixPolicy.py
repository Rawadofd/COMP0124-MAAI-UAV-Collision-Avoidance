...
class QMixPolicy(RecurrentPolicy):
    ...
    # ============================================= t_env, explore =============================================== #
    def get_actions(self, obs, prev_actions, rnn_states, available_actions=None, t_env=25, explore=True):
        """See parent class."""
    ...
    # ============================================= t_env, explore =============================================== #
    def actions_from_q(self, q_values, available_actions=None, explore=True, t_env=25):
        """
        ...
        if self.multidiscrete:
            ...
            # ============ Make Sure the no_sequence is True ============== #
            no_sequence = True
        else:
